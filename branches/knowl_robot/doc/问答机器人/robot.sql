...
CREATE TABLE A_LOG (
    ...
    CMS_VERSION VARCHAR2(16) NOT NULL
);

--机器人问答配置表
TRUNCATE TABLE ROBOT_QA_SET;
DROP TABLE ROBOT_QA_SET;
CREATE TABLE ROBOT_QA_SET (
    ID          VARCHAR2(16) CONSTRAINT PK_ROBOT_QA_SET PRIMARY KEY USING INDEX TABLESPACE EDU_INDEX,
    Q           VARCHAR2(100) NOT NULL,
