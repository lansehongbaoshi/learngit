                   ...
                   <div class="col-sm-12 widget-container-col ui-sortable">
                                        <div class="widget-box transparent ui-sortable-handle">
                                            <div class="widget-header">
                                                ...
                                                <div class="widget-toolbar no-border" data-id="<s:property value=" knowledgeData.id " />" style="display: none">
                            ...
                            <div class="widget-body">
                                <div class="widget-main padding-8">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>当前状态：</dt>
                                        <dd> <span class="label label-sm label-success"><s:property value=" knowledgeData.knowledgeStatus " /></span> </dd>
                                        <dt>知识类型：</dt>
