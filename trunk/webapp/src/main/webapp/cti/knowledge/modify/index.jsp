...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-xs-12">
      <form id="myform" action="<%=ctxPath%>/cti/knowledge/searchindex/modifyindex/updateSelfKnowledge.action" method="post" enctype="multipart/form-data" class="form-horizontal">
