...
<button type="button" id="searchBtn" class="btn btn-purple btn-sm">
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <span class="col-xs-5">
                            <a  href="/htgl/knowledge/searchindex/addindex.action" target="_blank"  class="btn-new-mail pull-right">
    ...
    <form id="modifyForm" action="/htgl/knowledge/searchindex/modifyindex.action" method="post" target="_blank">
