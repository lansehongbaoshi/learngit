...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<form id="myform" action="<%=ctxPath%>/htgl/addKnowledge.action"
				method="post" enctype="multipart/form-data">
				系统： <select id="systemIds" name="systemId">
				</select> <input type="hidden" id="content" name="content" value="">
				<p>
				...
				<p>
					热点度： <input id="sort" type="text" name="sort" style="width: 100px;"
						value=""> <span>（说明：1~99之间的数字,数值越大,序越靠前）<span>
				</p>
			</form>
