...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-xs-12">
      <form id="myform" action="<%=ctxPath%>/htgl/knowledge/checkUpdate.action" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkTheForm(this)">
