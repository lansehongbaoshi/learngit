...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		<li><i class="ace-icon fa fa-home home-icon"></i> <a
			href="/admin/cti/index.action">首页</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<form id="myform"
				action="<%=ctxPath%>/admin/cti/knowledge/searchindex/addindex/addDSHKnowledge.action"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="sort" type="text" name="sort" style="width: 100px;"
							value="20" > <span>（说明：1~999之间的整数,数值越大,排序越靠前）</span>
					</div>
				</div>
				<div class="form-group">
