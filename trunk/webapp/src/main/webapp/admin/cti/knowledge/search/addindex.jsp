...
.zxx_text_overflow_1{width:27em; white-space:nowrap; text-overflow:ellipsis; -o-text-overflow:ellipsis; overflow:hidden;}
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="/admin/cti/index.action">首页</a> </li>
...
<!--         <option value="PUBLIC">公开</option> -->
       ...
       <div class="col-xs-12 col-md-2">
        ...
        <input id="keywords" type="text" style="display: none" class="form-control search-query" placeholder="知识标题、回答、标签、关键字..." name="keywords" />
...
<button type="button" id="searchBtn" class="btn btn-purple btn-sm">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <span class="col-xs-5" style="display: none">
                            <a  href="/admin/cti/knowledge/searchadd/addindex.action" target="_self"  class="btn-new-mail pull-right">
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable" role="grid" aria-describedby="dynamic-table_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th width="70" class="hidden-480" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">修改人</th>
                                            <th width="80" class="hidden-480" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">修改时间</th>
    ...
    <form id="modifyForm" action="/admin/cti/knowledge/searchadd/modifyadd.action" method="post" target="_self">
    <input type="hidden" id="theId" name="id">
    </form>
    <script type="text/javascript">
        function showSearchResult(systemId, keywords, curPage) {
            $.getJSON("/admin/cti/search/searchSelfDSHKnow.action", {
                    systemId: systemId,
                    keywords: keywords,
                    tag:$("#tags").val(),
                    type:$("#type").val(),
                    ...
                    if (json.flag == 'true') {
                        ...
                        for (var i = 0; i < knows.length; i++) {
                            ...
                            if(k.topTime==-1){//未置顶热点问题
                                var str = " <tr role=\"row\" data-id="+k.knowId+" class=\""+odd_even+"\"><td class=\"hidden-80\" title=\""+k.systems+"\">" + k.system + "</td><td class=\"hidden-80\">" + k.tags + "</td><td class=\"hidden-160\">" + (k.hasImage?("<i class=\"ace-icon fa fa-image bigger-130\"></i>&nbsp;"+k.title):k.title) + "</td><td class=\"hidden-260\"><div class='zxx_text_overflow_1' title='"+ k.contentTxt +"'>" + k.contentTxt + "<div></td><td class=\"hidden-80\">"+k.creater+"</td><td class=\"hidden-80\">"+k.createTime+"</td><td class=\"hidden-80\">"+k.updater+"</td><td class=\"hidden-80\">"+k.updateTime+"</td><td class=\hidden-80\><span class=\"label label-sm label-success\">待审核</span><span class=\"label label-sm label-success\">"+k.typeDic+"</span></td><td><div class=\"hidden-sm hidden-xs action-buttons\"><a class=\"blue\" target='_blank' title=\"查看\" href=\"/admin/cti/knowledge/searchadd/showKnowledge.action?id=" + k.knowId +"\"> <i class=\"ace-icon fa fa-search-plus bigger-130\"></i> </a> <a class=\"green\" title=\"修改\" href='javascript:void(0)' class='modifyclass'><i class=\"ace-icon fa fa-pencil bigger-130\"></i> </a> <a title=\"删除\" class=\"red delBtn\" href='javascript:void(0)' style=\"display:none\"> <i class=\"ace-icon fa fa-trash-o bigger-130\"></i> </a></div>" + "</td></tr>";

                            }else{//已置顶热点问题
                            	var str = " <tr role=\"row\" data-id="+k.knowId+" class=\""+odd_even+"\"><td class=\"hidden-80\" title=\""+k.systems+"\">" + k.system + "</td><td class=\"hidden-80\">" + k.tags + "</td><td class=\"hidden-160\">" + (k.hasImage?("<i class=\"ace-icon fa fa-image bigger-130\"></i>&nbsp;"+k.title):k.title) + "</td><td class=\"hidden-260\">" + k.summary + "</td><td class=\"hidden-80\">"+k.creater+"</td><td class=\"hidden-80\">"+k.createTime+"</td><td class=\"hidden-80\">"+k.updater+"</td><td class=\"hidden-80\">"+k.updateTime+"</td><td class=\hidden-80\><span class=\"label label-sm label-success\">待审核</span><span class=\"label label-sm label-success\">"+k.typeDic+"</span></td><td><div class=\"hidden-sm hidden-xs action-buttons\"><a class=\"blue\" target='_blank' title=\"查看\" href=\"/admin/cti/knowledge/searchadd/showKnowledge.action?id=" + k.knowId +"\"> <i class=\"ace-icon fa fa-search-plus bigger-130\"></i> </a> <a class=\"green\" title=\"修改\" href='javascript:void(0)' class='modifyclass'><i class=\"ace-icon fa fa-pencil bigger-130\"></i> </a> <a title=\"删除\" class=\"red delBtn\" href='javascript:void(0)' style=\"display:none\"> <i class=\"ace-icon fa fa-trash-o bigger-130\"></i> </a></div>" + "</td></tr>";
        ...
        $(function () {
            $.getJSON("/admin/cti/listSystem.action",
            ...
            $(document).on("change","#systemIds",function() {
            	...
            	$.getJSON("/admin/cti/listTag.action",data,
            ...
            $(document).on("click",".delBtn",function() {
                if(confirm("确定删除该知识点？")) {
                    ...
                    $.getJSON(
                        "<%=ctxPath%>/admin/cti/knowledge/searchadd/delKnowledge.action",
                        {id:knowId},
                        function(data){
                            if(data.flag=='true') {
                                alert("删除成功");
