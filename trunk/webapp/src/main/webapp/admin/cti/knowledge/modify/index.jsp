...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-xs-12">
      <form id="myform" action="<%=ctxPath%>/admin/cti/knowledge/searchindex/modifyindex/updateSelfKnowledge.action" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkTheForm(this)">
...
$(function(){
	...
	$("#modifyBtn").click(function () {
        ...
        $.getJSON("/admin/cti/knowledge/searchadd/addindex/checkBadWord.action", {
        	content : content,
            title : title,
            keywords: keywords,
            t: new Date().getTime()
...
function checkTitle() {
    ...
    $.getJSON("/admin/cti/knowledge/searchadd/addindex/checkRepeat.action", {
        keywords : title,
        knowId:"${id}",
        t : new Date().getTime()
...
UE.Editor.prototype.getActionUrl = function(action) {
    if (action == 'uploadimage' || action == 'uploadfile') {
        return 'http://kl.chsi.com.cn/admin/cti/file/up.action';
