    ...
    <div class="col-xs-12">
      <form id="myform" action="<%=ctxPath%>/admin/knowledge/searchindex/addindex/addKnowledge.action" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkTheForm(this)">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input id="sort" type="text" name="sort" style="width: 100px;" value="" check="^[1-9]\d*$" warn="关键词个数为正整数" max="99" min="1"> <span>（说明：1~99之间的整数,数值越大,排序越靠前）</span>
          </div>
        </div>
        <div class="form-group">
...
//	    searchInputIng();
	...
	$('#title').autocomplete({
        ...
        source : function(request, response) {
            ...
            var _url = "http://kl.chsi.com.cn/admin/knowledge/quickAll.action";
            $.ajax({
                type : "get",
                cache : false,
                async : true,
