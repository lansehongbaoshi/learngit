...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-xs-12">
      <form id="myform" action="<%=ctxPath%>/admin/knowledge/searchindex/addindex/addKnowledge.action" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkTheForm(this)">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input id="keywords" type="text" name="keywords" style="width: 200px;" value=""> <span>（建议：2~3个,英文逗号,隔开）</span>
          </div>
        </div>
        <div class="form-group">
          <label for="" class="col-sm-1 control-label no-padding-top">热点度：</label>
          <div class="col-sm-9">
            <input id="sort" type="text" name="sort" style="width: 100px;" value="" check="^[1-9]\d*$" warn="关键词个数为正整数" max="999" min="1"> <span>（说明：1~999之间的整数,数值越大,排序越靠前）</span>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><b><%=system.getName()%>：</b>
          ...
          %>
          <span style="margin: 0 1px;"><input type="checkbox" name="tagIds" value="<%=tag.getId()%>" title="<%=tag.getName()%>"><%=tag.getName()%></span>
          <%
              }
          %>
        </p>
