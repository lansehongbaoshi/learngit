    ...
    $(function(){
        $("a[data-action='update-time']").on("click",function(){
            if(confirm("确定要修改该知识的更新时间为当前时间？")) {
                document.location.href="/admin/knowledge/searchindex/updateKnowledgeTime.action?id=<s:property value=" knowledgeData.id " />";
            }
        });
...
<div class="page-content">
    ...
    <form id="modifyForm" action="/admin/knowledge/searchindex/modifyindex.action"
        method="post" target="">
