...
<div class="page-content">
  <div class="rows">
    <div class="col-xs-12">
      ...
      <h3 class="row header smaller lighter blue"> <span class="col-xs-7">常用语对话配置</span> <span class="col-xs-5"> <a href="/admin/robot/set/addIndex.action" target="_self" class="btn-new-mail pull-right"> <span class="btn btn-primary btn-xs no-border"> <i class="ace-icon fa glyphicon-plus bigger-130"></i> <span class="bigger-110">新增</span></span> </a> </span> </h3>
          ...
          <tbody id="systemIds">
            <s:iterator value="qaSet" id="entry">
              ...
              <s:if test="not key.systemDefined">
                ...
                <td class="hidden-260"><div class="hidden-sm hidden-xs action-buttons" data-id="<s:property value='key.id'/>"> <a class="green" title="修改" target='_self' href="/admin/robot/set/updateIndex.action?id=<s:property value='key.id'/>"><i class="ace-icon fa fa-pencil bigger-130"></i> </a> <a title="删除" class="red delBtn" href="javascript:void(0)"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a> </div></td>
              </s:if>
              </tr>
            </s:iterator>
          </tbody>
...
<script type="text/javascript">
function showSearchResult(text,type,start,max){
	$.getJSON("/admin/system/list.action", {
		text: text,
		type: "question",
        type:$("#type").val(),
        curPage: curPage,
