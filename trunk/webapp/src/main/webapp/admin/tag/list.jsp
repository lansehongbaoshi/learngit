...
<div class="page-content">
  <!-- <div class="page-header">
    <h1>
      标签管理 <small> <i class="ace-icon fa fa-angle-double-right"></i> 根据条件查询
      </small>
    </h1>
  </div> -->
  <br>
  <div class="rows">
    ...
    <div class="col-xs-12 col-md-1">
      <a href="/admin/tag/addIndex.action" target="_self" class="btn-new-mail pull-right"> 
  ...
  <div class="rows">
    <div class="col-xs-12">
      <div class="row">
        <div class="col-xs-12">
          <h3 class="row header smaller lighter blue"></h3>
              ...
              <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable" role="grid" aria-describedby="dynamic-table_info">
                <thead>
                  <tr role="row">
                    ...
                    <th width="100" class="hidden-100" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">标签排序</th>
                    <th width="100" class="hidden-100" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">知识数目</th>
                    <th width="50" class="hidden-100" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">默认标签</th>
