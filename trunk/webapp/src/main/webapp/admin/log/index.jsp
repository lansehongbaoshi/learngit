...
function formatP(pagination, startDate, endDate, curPage) {
    ...
    var nextPage = "";
    if (curPage - 1 >= 0) {
    	prePage  = " <li class=\"paginate_button frist\" aria-controls=\"dynamic-table\" tabindex=\"0\" id=\"dynamic-table_frist\"><a href=\"javascript:void(0)\" onclick=\"showSearchResult('" + startDate + "','" + endDate + "','0')\">首页</a>";
    ...
    if (curPage + 1 < pageCount) {
        ...
        nextPage += " <li class=\"paginate_button last\" aria-controls=\"dynamic-table\" tabindex=\"0\" id=\"dynamic-table_last\"><a href=\"javascript:void(0)\" onclick=\"showSearchResult('" + startDate + "','" + endDate + "','" + (pageCount-1) + "')\">末页</a></li>";
    }
